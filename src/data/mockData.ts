...
export const mockProjects: Project[] = [
  {
    ...
    titleAr: 'مبادرة السرد الرقمي',
    description: 'Empowering Syrian voices through multimedia storytelling and digital preservation of cultural heritage. This initiative provides training and resources for community members to document and share their stories.',
    descriptionAr: 'تمكين الأصوات السورية من خلال السرد متعدد الوسائط والحفظ الرقمي للتراث الثقافي. توفر هذه المبادرة التدريب والموارد لأعضاء المجتمع لتوثيق ومشاركة قصصهم.',
    location: 'Damascus',
  ...
  },
  {
    ...
    titleAr: 'شبكة الحدائق المجتمعية',
    description: 'Creating sustainable food systems and social spaces in refugee settlements and host communities. Building connections through shared agricultural practices and cultural exchange.',
    descriptionAr: 'إنشاء أنظمة غذائية مستدامة ومساحات اجتماعية في مستوطنات اللاجئين والمجتمعات المضيفة. بناء الروابط من خلال الممارسات الزراعية المشتركة والتبادل الثقافي.',
    location: 'Aleppo',
