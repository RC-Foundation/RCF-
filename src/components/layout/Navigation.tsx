            ...
            <div className="relative">
              <button
                ...
                className={`flex items-center space-x-1 px-2 py-2 text-sm font-medium transition-colors duration-200 ${
                  isScrolled ? 'text-stone-700 hover:text-emerald-700' : 'text-white hover:text-emerald-200'
                }`}
              >
                    ...
                    {languages.map((lang) => (
                      <button
                        ...
                        className={`w-full text-left px-4 py-2 text-sm hover:bg-emerald-50 transition-colors ${
                          currentLanguage.code === lang.code ? 'text-emerald-700 font-medium' : 'text-stone-700'
